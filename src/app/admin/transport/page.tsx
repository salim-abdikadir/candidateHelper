        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage transportation routes and vehicle logistics
            </p>
          </div>
      ...
      <div className="grid auto-rows-min gap-4 grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="card-professional">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">6 buses, 39 cars</p>
          </CardContent>
        </Card>
        ...
        <Card className="card-professional">
          ...
          <CardContent>
            <div className="text-lg font-bold text-foreground">2,847 km</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    { name: "Burao Route", passengers: 15, efficiency: 82 },
                  ].map((route, index) => (
                    <div
                      key={index}
          ...
          <Card className="card-professional">
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Vehicle tracking and management tools will be available here
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="card-professional">
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Detailed transport analytics will be available here
                </p>
              </div>
            </CardContent>
          </Card>
